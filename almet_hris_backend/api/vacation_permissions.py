# api/vacation_permissions.py - FINAL VERSION
...
def has_vacation_permission(permission_codename):
    """
    Decorator to check vacation permissions
        ...
        def wrapper(request, *args, **kwargs):
            ...
            try:
                ...
                return Response({
                    ...
                    'detail': 'Vacation sisteminə daxil olmaq üçün employee profili lazımdır'
...
def has_any_vacation_permission(permission_codenames):
    """
...
def check_vacation_permission(user, permission_codename):
    """
...
def get_user_vacation_permissions(user):
    """
    Get all vacation permissions for user
    Returns: list of permission codenames
    """
    if is_admin_user(user):
        # Admin has all vacation permissions
